  ...
  <form class="trip-events__trip-sort trip-sort" action="#" method="get">
    <div class="trip-sort__item trip-sort__item--day">
      <input
        ...
        value="${SortType.DAY}"
        data-sort-type="day"
        ${currentSort === SortType.DAY ? 'checked' : ''}
      >
    ...
    <div class="trip-sort__item trip-sort__item--time">
      <input
        ...
        value="${SortType.TIME}"
        data-sort-type="time"
        ${currentSort === SortType.TIME ? 'checked' : ''}
      >
    ...
    <div class="trip-sort__item trip-sort__item--price">
      <input
        ...
        ${currentSort === SortType.PRICE ? 'checked' : ''}
      >
...
export default class SortingView extends AbstractView {
  ...
  #handleSortChange = (evt) => {
    ...
    if (sortType && this.#currentSortType !== sortType && this.#onSortChange) {
  ...
  updateSort(selectedSort) {
    ...
    this.#currentSortType = selectedSort;
